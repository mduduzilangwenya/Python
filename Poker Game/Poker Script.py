...
# set up rank, suit, and hand rank
...
#1. get probabilities when getting five cards at once

Deck().get_five_cards(number_of_hands = 100000, HAND_RANK = HAND_RANK)            

#2. get conditional hand rank probability, after the first 2 cards are drawn
